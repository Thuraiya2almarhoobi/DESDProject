...
class DemoSeeder:
    ...
    def seed_content(self) -> None:
        ...
        recipe("avon.orchards@example.com", "Apple Yogurt Pots", "AI-generated breakfast pots using apples and organic yogurt.", "Fresh apples\nOrganic Greek yogurt\nApple crisps\nHoney", "Dice apples, layer with yogurt, top with apple crisps, and chill until service.", "Autumn", ["Fresh Apples", "Organic Greek Yogurt", "Apple Crisps"], "https://images.unsplash.com/photo-1488477181946-6428a029177?w=900", ai=True)
