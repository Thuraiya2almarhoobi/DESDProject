...
from .views import (
    ...
    OrderReceiptAPIView,
    OrderReorderAPIView,
    FavoriteProducerListAPIView,
    ProducerFavoriteAPIView,
    ProducerListCreateAPIView,
    ProducerSubOrderListAPIView,
    ProducerSubOrderStatusUpdateAPIView,
    ProductAllergenAcknowledgementAPIView,
...
urlpatterns = [
    ...
    path("producers/favorites/", FavoriteProducerListAPIView.as_view(), name="orders-producer-favorites"),
    path("producers/<int:producer_id>/favorite/", ProducerFavoriteAPIView.as_view(), name="orders-producer-favorite"),
    ...
    path(
        "products/<int:product_id>/allergen-acknowledgement/",
        ProductAllergenAcknowledgementAPIView.as_view(),
        name="orders-product-allergen-acknowledgement",
    ),
    ...
    path(
        ...
        name="orders-product-review-detail",
    ),
    path(
