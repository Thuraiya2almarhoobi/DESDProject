 ...
 *
 * File role:
 *   Implements the AboutPage browser route and coordinates the UI state for that screen.
 *
 * Frontend context:
 ...
 * AboutPage boundary.
 *
 * This exported unit supports the file role: Implements the AboutPage browser route and coordinates the UI state for that screen.
