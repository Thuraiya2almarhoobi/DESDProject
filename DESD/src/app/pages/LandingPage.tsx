          ...
          <div className="mx-auto grid w-full min-w-0 max-w-7xl gap-6 px-4 lg:grid-cols-[1.08fr_0.92fr] lg:items-center xl:gap-10">
            <div className="min-w-0 space-y-6 xl:space-y-8">
              ...
              <div className="grid max-w-2xl gap-3 sm:grid-cols-2">
                ...
                >
                  <span className="text-sm font-semibold text-[var(--forest-green)]">New to the marketplace?</span>
              ...
              <p className="max-w-2xl text-sm text-[oklch(0.42_0.032_118)]">
                Interested in selling?{' '}
                <Link to="/register/producer" className="font-semibold text-[var(--forest-green)] underline-offset-4 hover:underline">
