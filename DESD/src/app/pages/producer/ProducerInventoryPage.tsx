...
export function ProducerInventoryPage() {
  ...
  useEffect(() => {
    ...
    setFilterHealthStatus(parseHealthFilter(params.get('filter')));
  ...
  const handleCreateDialogChange = (open: boolean) => {
    ...
    if (!open) {
      ...
      if (params.get('create') === 'product') {
        ...
        navigate(nextSearch ? `/producer/inventory?${nextSearch}` : '/producer/inventory', { replace: true });
      }
    }
  };
